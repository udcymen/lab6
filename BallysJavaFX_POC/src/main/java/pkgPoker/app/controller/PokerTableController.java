...
public class PokerTableController implements Initializable {
	...
	private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		path.getElements().add(new CubicCurveTo(toPoint.getX() + 360, toPoint.getY() + 12, toPoint.getX()+200,
				toPoint.getY()+12, toPoint.getX()+33, toPoint.getY()+12));
		// path.getElements().add(new CubicCurveTo(0+360, 120+12, 0+200, 240+12, 380+33, 240+12));
